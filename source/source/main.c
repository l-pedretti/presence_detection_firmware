...
* File Name:   main.c
*
* Description: This is the source code for Thermistor MQTT Client to Sensor Cloud Example for Rapid IOT Connect.
*
...
int main()
{
    ...
    printf("\x1b[2J\x1b[;H");
    printf("===============================================================\n");
    printf(" Example: Radar Presence to Sensor Cloud Code Example, CE v%s\n", CE_VERSION);
    printf("===============================================================\n\n");
